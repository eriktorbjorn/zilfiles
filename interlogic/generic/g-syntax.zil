"SYNTAX for GENERIC: (C)1985 Infocom, Inc. All Rights Reserved."

<BUZZ A AN THE IS ARE AM AND OF THEN ALL BUT EXCEPT \. \, \" 
      PRY HERE SOME FRONT MR MISS MRS MONEY ; PLEASE>
...
<SYNTAX BREAK DOWN OBJECT (ON-GROUND IN-ROOM HELD CARRIED)
	WITH OBJECT (HAVE HELD CARRIED) = V-MUNG>
<SYNTAX BREAK INTO OBJECT (ON-GROUND IN-ROOM) = V-MUNG>
<SYNTAX BREAK INTO OBJECT (ON-GROUND IN-ROOM)
	WITH OBJECT (HAVE HELD CARRIED) = V-MUNG>
...
<SYNONYM KILL MURDER HURT SLAY HIT SLAP WHACK STRIKE STAB PUNCH WOUND
	 ; "DISPATCH VANQUISH" >
...
<SYNTAX POUR OUT OBJECT (HELD CARRIED) INTO OBJECT = V-POUR>
...
<SYNONYM TURN ROTATE FLIP SHUT SET>
