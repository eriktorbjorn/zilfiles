	...
	<COND (<AND <OUTSIDE? ,HERE> ;<NOT <EQUAL? ,HERE ,CAR>>>
	      ...
	      (<VERB? LAMP-OFF>
	       <COND (<NOT <FSET? ,HERE ,ONBIT>>
		     ...
		     (<SET P <FIND-FLAG-HERE-NOT ,ACTORBIT ,MUNGBIT ,PLAYER>>
		      <TELL
...
;<ROUTINE HANDS-F ("AUX" P A)
 ...
 <COND ;(<EQUAL? .P ,PLAYER>
	...
	;<COND (<ZERO? .P>
	       <COND ;(<ADJ-USED? ,W?HER>
		      <SET P <FIND-FLAG-HERE-BOTH ,ACTORBIT ,FEMALE ,WINNER>>
		      <COND (<ZERO? .P>
			     <TELL "There's no woman here!" CR>
			     <RTRUE>)>)
		     ;(<ADJ-USED? ,W?HIS>
		      <SET P <FIND-FLAG-HERE-NOT ,ACTORBIT ,FEMALE ,WINNER>>
		      <COND (<ZERO? .P>
			     <TELL "There's no man here!" CR>
			     <RTRUE>)>)
		     (T
		      <SET P <FIND-FLAG-HERE ,ACTORBIT ,WINNER>>
		      <COND (<ZERO? .P>
