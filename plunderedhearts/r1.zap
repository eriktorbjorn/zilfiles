...
?L1:	CALL PERFORM,V?GIVE,PRSI,PRSO
	...
	CRLF
	JUMP ?L3
?L1:	PRINTR "Ladies do not play with fire."
...
?L6:	CALL HELD?,PRSO >STACK
	ZERO? STACK /?L7
	CALL DO-FIRST,STR?117,PRSO >STACK
	RSTACK
...
?L9:	CALL CANT-VERB-A-PRSO,STR?118 >STACK
	RSTACK
...
?L4:	GET P-ITBL,P-PREP1 >STACK
	...
	CALL CANT-VERB-A-PRSO,STR?119 >STACK
	RSTACK
?L5:	CALL CANT-VERB-A-PRSO,STR?120 >STACK
	RSTACK
...
?L3:	FSET? PRSO,SURFACEBIT /?L1
	...
	RSTACK
?L1:	CALL CANT-VERB-A-PRSO,STR?121 >STACK
	RSTACK
...
?L1:	CALL IMPOSSIBLES >STACK
	...
	.FUNCT V-CRY
	CALL NO-TIME-FOR,STR?122 >STACK
	RSTACK
...
?L4:	FSET? PRSO,ACTORBIT \?L6
	...
	RTRUE
?L6:	PRINTR "Your fingernails aren't that sharp!"
...
?L12:	FSET? PRSO,NARTICLEBIT \?L16
	CALL SENSE-OBJECT,STR?125 >STACK
	RSTACK
...
?L1:	CALL RECOGNIZE >STACK
	...
	PRINT DOESNT-RESPOND
	RTRUE
?L3:	PRINTR """Hey! Cut that out!"""
?L1:	CALL HACK-HACK,STR?127 >STACK
	RSTACK
...
?L7:	ZERO? PRSO /?L8
	CALL SENSE-OBJECT,STR?129 >STACK
	RSTACK
...
?L16:	FSET? PRSO,OPENBIT /?L21
	...
	RTRUE
?L21:	CALL DO-FIRST,STR?130,PRSO >STACK
	RSTACK
?L15:	GET P-ITBL,P-PREP1 >STACK
	EQUAL? STACK,PR?IN \?L26
	CALL CANT-VERB-A-PRSO,STR?131 >STACK
	RSTACK
...
?L1:	CALL PERFORM,V?LOOK-INSIDE,PRSO
	...
	SET 'KISSEE,PRSO
	JUMP ?L3
?L1:	CALL FIND-IN,HERE,ACTORBIT,STR?132 >KISSEE
	ZERO? KISSEE \?L3
	SET 'KISSEE,ME
...
?L4:	EQUAL? P-PRSA-WORD,W?PULL \?L5
	...
	RSTACK
?L5:	CALL CANT-VERB-A-PRSO,STR?135 >STACK
	RSTACK
...
?L15:	CALL YOU-SOUND,STR?138 >STACK
	RSTACK
...
?L1:	CALL CANT-VERB-A-PRSO,STR?139 >STACK
	RSTACK
...
?L4:	FSET PRSO,ONBIT
	...
	CALL TPRINT-PRSO
	PRINTR " is now on."
?L3:	CALL CANT-VERB-A-PRSO,STR?140 >STACK
	RSTACK
...
?L4:	FSET? PRSO,SURFACEBIT /?L3
	...
	CALL OPEN-CLOSE,PRSO >STACK
	RSTACK
?L3:	CALL CANT-VERB-A-PRSO,STR?130 >STACK
	RSTACK
	...
	PRINT PCR
	RTRUE
?L1:	CALL CANT-VERB-A-PRSO,STR?141 >STACK
	RSTACK
	...
	CALL SPECIFY-WHAT,STR?142,PRSO >STACK
	RSTACK
...
?L5:	FSET? PRSI,OPENBIT /?L6
	...
	CALL THIS-IS-IT,PRSI
	CALL DO-FIRST,STR?130,PRSI >STACK
	RSTACK
?L6:	IN? PRSO,PRSI \?L7
	PRINTI "But"
	CALL TPRINT-PRSO
...
?L3:	PRINTI "There's no good surface on"
	...
	CALL V-THROW >STACK
	RSTACK
?L3:	CALL DO-FIRST,STR?130,PRSI >STACK
	RSTACK
?L1:	LOC PROTAGONIST >STACK
	EQUAL? PRSI,STACK \?L6
...
?L2:	FSET? PRSO,OPENBIT /?L5
	CALL DO-FIRST,STR?130,PRSO >STACK
	RSTACK
?L5:	ZERO? OBJ /?L7
...
?L6:	PRINTI "You feel something inside"
	...
	.FUNCT V-READ
	CALL CANT-VERB-A-PRSO,STR?145 >STACK
	RSTACK
...
?L6:	PRINTI "I'll do that."""
	...
	ZERO? PRSI \?L1
	CALL FIND-IN,HERE,ACTORBIT,STR?146 >ACTOR
	ZERO? ACTOR /?L3
	CALL PERFORM,V?GIVE,PRSO,ACTOR
	RTRUE
?L3:	CALL NO-ONE-HERE,STR?147 >STACK
	RSTACK
...
?L4:	LOC PROTAGONIST >STACK
	...
	CALL WASTES >STACK
	RSTACK
?L7:	CALL DO-FIRST,STR?148,SKIFF >STACK
	RSTACK
...
?L4:	FSET? PRSO,CONTBIT \?L5
	...
	PRINT PCR
	RTRUE
?L5:	CALL CANT-VERB-A-PRSO,STR?149 >STACK
	RSTACK
...
?L3:	CALL PROPOSE >STACK
	RSTACK
?L1:	PRINTR "Don't ever bother applying for a job as a gunswoman."
...
?L6:	PRINTI "Nothing smells unusual"
	...
	.FUNCT V-SOAK
	ZERO? PRSI \?L1
	CALL SPECIFY-WHAT,STR?152,PRSO >STACK
	RSTACK
?L1:	CALL IMPOSSIBLES >STACK
	RSTACK
...
?L6:	PRINTR "!"
	...
	ZERO? STACK /?L1
?L3:	CALL REPERTOIRE,STR?154 >STACK
	RSTACK
...
?L1:	CALL CANT-VERB-A-PRSO,STR?155
	CALL STOP >STACK
	RSTACK
...
?L5:	CALL CANT-VERB-A-PRSO,STR?156 >STACK
	RSTACK
...
?L4:	CALL CHECK-STRIP >STACK
	...
	IN? DAD,HERE \FALSE
?L6:	CALL FIND-IN,HERE,ACTORBIT,STR?158 >STACK
	ZERO? STACK \?L9
...
?L10:	EQUAL? PRSO,0,RETICULE /FALSE
	...
	.FUNCT PRE-WEAR
	FSET? PRSO,WEARBIT /?L1
	CALL CANT-VERB-A-PRSO,STR?159 >STACK
	RSTACK
...
?L16:	CALL YOU-SOUND,STR?160 >STACK
	RSTACK
...
?L14:	IN? PRSO,PROTAGONIST /?L21
	...
	LOC PRSO >STACK
	CALL DO-FIRST,STR?130,STACK >STACK
	RSTACK
?L21:	FSET? PRSO,WORNBIT \FALSE
	CALL DO-FIRST,STR?161,PRSO >STACK
	RSTACK
...
?L24:	EQUAL? PRSA,V?CLIMB-DOWN \?L25
	...
	CALL DO-FIRST,STR?163,LADDER >STACK
	RSTACK
...
?L1:	EQUAL? PRSA,V?SHAKE \?L3
	CALL FIND-IN,HERE,ACTORBIT,STR?132 >ACTOR
	ZERO? ACTOR /?L4
...
?L23:	PRINT SUICIDE
	RTRUE
?L22:	EQUAL? PRSA,V?WHERE,V?FIND \?L24
	PRINTI "You're in"
	CALL TRPRINT,HERE
	RTRUE
?L24:	EQUAL? PRSA,V?FOLLOW \?L25
	PRINTR "Next time, please specify who you wish to follow."
?L25:	EQUAL? PRSA,V?EMBRACE,V?KISS \FALSE
...
?L8:	FSET? POOP,TOUCHBIT /?L10
	...
	CALL DO-FIRST,STR?164,LADDER
	RFALSE
?L11:	CALL DO-FIRST,STR?163,LEDGE
	RFALSE
...
?L8:	EQUAL? P-WALK-DIR,P?UP /FALSE
	CALL DO-FIRST,STR?168,LEDGE >STACK
	RSTACK
?L1:	ZERO? VARG \FALSE
...
?L18:	EQUAL? PRSA,V?LEAP-OFF \?L19
	...
	CALL DO-FIRST,STR?120,LEDGE >STACK
	RSTACK
?L20:	PRINT SUICIDE
	RTRUE
...
?L1:	EQUAL? RARG,M-BEG \FALSE
	...
	CALL DO-FIRST,STR?130,CUPBOARD-OBJECT
	RFALSE
...
?L9:	CALL TOUCHING?,PYRAMID >STACK
	ZERO? STACK /FALSE
?L8:	CALL DO-FIRST,STR?175,CASK >STACK
	RSTACK
...
?L17:	EQUAL? PRSA,V?ROW \?L21
	...
	CALL DO-FIRST,STR?180,SKIFF >STACK
	RSTACK
?L24:	PRINT YOULL-HAVE-TO
	...
	PRINT PCR
	RTRUE
?L22:	CALL DO-FIRST,STR?148,SKIFF >STACK
	RSTACK
...
?L30:	CALL H-JIGS-UP,STR?181 >STACK
	RSTACK
...
?L77:	EQUAL? PRSA,V?MUNG,V?KICK,V?KILL \?L78
	CALL MAN-IS-DOWN >STACK
	RSTACK
?L78:	EQUAL? PRSA,V?MOVE \?L79
	PRINTR "He's too heavy."
?L79:	EQUAL? PRSA,V?EMBRACE,V?KISS \?L80
	PRINTI "You press your lips to his cold mouth. "
	PRINT DOESNT-RESPOND
	RTRUE
?L80:	EQUAL? PRSA,V?ASK-ABOUT,V?TELL-ABOUT,V?TELL \?L83
	EQUAL? PRSO,HERO \?L82
?L83:	CALL TOUCHING?,HERO >STACK
	ZERO? STACK /FALSE
?L82:	PRINT DOESNT-RESPOND
	RTRUE
?L74:	EQUAL? PRSA,V?GIVE \?L85
	EQUAL? PRSO,SALTS \?L86
	CALL REVIVE-HERO >STACK
	RSTACK
?L86:	EQUAL? PRSO,BANKNOTE \?L88
	PRINTD HERO
	PRINTI " returns"
...
?L95:	PRINTD HERO
	...
	PRINT PCR
	RTRUE
?L92:	EQUAL? PRSA,V?UNTIE \?L97
	EQUAL? P-PRSA-WORD,W?FREE \?L97
	IN? HERO,MANACLES \?L98
	SET 'AWAITING-REPLY,2
	CALL QUEUE,I-REPLY,2
	PRINTR "You have the key, maybe?"
?L98:	PRINTI "Jamison is free enough as it is"
	PRINT PCR
	RTRUE
?L97:	EQUAL? PRSA,V?MUNG,V?KICK,V?KILL \?L101
	PRINTI """Please, I'm not trying to hurt you,"""
	EQUAL? HERE,CABIN \?L102
	PRINTI " the stranger"
	JUMP ?L104
?L102:	CALL TPRINT,HERO
?L104:	PRINTI " says, casually deflecting the blow"
	PRINT PCR
	RTRUE
?L101:	EQUAL? PRSA,V?KISS \?L105
	EQUAL? WINNER,PROTAGONIST \?L105
	EQUAL? HERE,CABIN,DEUX-DECK \?L106
	PRINTR "You are not so pert as to kiss a stranger, and a pirate, at that!"
?L106:	CALL SHIP-BOARD,HERE >STACK
	ZERO? STACK /?L108
	PRINTI "That thought has occurred to you before, but now does not seem appropriate"
	PRINT PCR
	RTRUE
?L108:	EQUAL? HERE,FOLLY \?L109
	SET 'REACTION,REACTION-POSITIVE
	PRINTI "You lean into his arms, face lifted"
	PRINT PCR
	RTRUE
?L109:	CALL RUNNING?,I-DUEL >STACK
	ZERO? STACK \?L111
	CALL RUNNING?,I-ENDGAME >STACK
	ZERO? STACK /?L110
?L111:	PRINTI "You would only distract"
	CALL TRPRINT,HERO
	RTRUE
?L110:	CALL RUNNING?,I-HDANCE >STACK
	ZERO? STACK /?L112
	...
	PRINT PCR
	RTRUE
?L112:	PRINTI "He kisses you back"
	PRINT PCR
	RTRUE
?L105:	EQUAL? PRSA,V?TELL-ABOUT \?L114
	CALL NOUN-USED,W?LIBRARY,HOUSE >STACK
	ZERO? STACK \?L117
	CALL NOUN-USED,W?CELL,CELL-4 >STACK
	ZERO? STACK \?L117
	EQUAL? PRSI,DUNGEON,PORTRAIT \?L115
?L117:	PRINTR "He nods. ""That area is guarded well."""
?L115:	EQUAL? PRSI,DAD \?L118
	IN? DAD,CELL-4 \?L119
	PRINTR "He smiles fondly at your reminiscing. ""I never knew my father -- he died when I was a boy."""
?L119:	SET 'HDAD-SPEECH,1
	PRINTR """Such bravery joined with such beauty!"""
?L118:	EQUAL? PRSI,CRULLEY \FALSE
	FSET? BEACH,TOUCHBIT \FALSE
	PRINTR """Crulley?! God's blood!"""
?L114:	EQUAL? PRSA,V?TOUCH,V?EMBRACE \?L124
	EQUAL? HERE,FOLLY \?L124
	CALL PERFORM,V?KISS,HERO
	RTRUE
?L124:	EQUAL? PRSA,V?DANCE \?L125
	EQUAL? HERE,BALLROOM \?L126
	EQUAL? PARTNER,HERO \?L126
	PRINT PACE
	RTRUE
?L126:	CALL RUNNING?,I-HDANCE >STACK
	ZERO? STACK /FALSE
...
?L4:	FSET KNOB,EVERYBIT
	CALL KNOB-CAUSES-TINGLE,STR?182 >STACK
	RSTACK
...
?L3:	PRINTR "One look at the sheer drop, from sill to hedge to jagged rocks far below, is enough to dissuade you."
...
?L1:	EQUAL? PRSO,WINE \?L8
	...
	CALL FWTD,SMACK-YOUR-FACE >STACK
	RSTACK
?L11:	CALL SPECIFY-WHAT,STR?142,PRSO >STACK
	RSTACK
...
?L28:	PRINTI " and brocade, dropping everything between you."
   ...
   Cookie leans over you. ""We must get back to the ship, Miss. Dragoons surround the house."" Nicholas, injured but still arguing, is already on the veranda, half-forced, half-supported by your father, shadowed by Lucy. Cookie helps you to your feet and rushes after them, expecting you to follow. Lafond lies nearby, apparently unconscious"
	...
	RSTACK
?L17:	CALL JIGS-UP,STR?187 >STACK
	RSTACK
?L15:	FSET? BALLROOM,EVERYBIT \?L30
	CALL JIGS-UP,STR?188 >STACK
	RSTACK
?L30:	CALL FWTD,STR?189 >STACK
	RSTACK
...
?L4:	EQUAL? PRSA,V?FILL \?L5
	EQUAL? PRSO,HORN \?L5
	CALL CANT-VERB-A-PRSO,STR?191 >STACK
	RSTACK
...
?L1:	EQUAL? PRSA,V?CLOSE \?L3
	...
	RTRUE
?L4:	CALL OPEN-CLOSE,PRSO,0,STR?192 >STACK
	RSTACK
...
?L3:	CALL OPEN-CLOSE,TRAP,STR?193,0 >STACK
	RSTACK
...
?L17:	CALL JIGS-UP,FALL-TO-BOTTOM >STACK
	RSTACK
...
?L21:	EQUAL? PRSO,RETICULE /FALSE
	FSET? CRULLEY,MUNGBIT \?L24
...
?L37:	EQUAL? PRSO,STONE \FALSE
	CALL DO-FIRST,STR?195,GARTER >STACK
	RSTACK
...
?L3:	EQUAL? PRSA,V?USE \?L7
	ZERO? PRSI \?L8
	CALL FIND-IN,HERE,ACTORBIT,STR?196 >PER
...
?L5:	EQUAL? PRSA,V?WRING,V?POUR-FROM \?L6
	EQUAL? PRSO,LAUD \?L6
	CALL SPECIFY-WHAT,STR?197,LAUD >STACK
	RSTACK
...
?L14:	FSET? HAT,EVERYBIT \FALSE
	...
	FSET HAT,WORNBIT
?L17:	CALL KNOB-CAUSES-TINGLE,STR?198 >STACK
	RSTACK
...
?L41:	IN? RAPIER,PROTAGONIST \?L42
	...
	RTRUE
?L42:	CALL CANT-HURT,STR?199 >STACK
	RSTACK
...
?L66:	EQUAL? PRSA,V?CUT,V?MUNG,V?KILL \FALSE
	...
	CALL MAN-IS-DOWN >STACK
	RSTACK
?L68:	PRINTR "He holds you off, ""'Ere now, there's no call for that!"""
...
?L30:	ZERO? KILL-L \?L31
	...
	EQUAL? PRSI,0,RETICULE /?L32
	FSET? PRSI,WORNBIT /?L32
	MOVE PRSI,LAFOND
	PRINTI ", taking"
	CALL TPRINT-PRSI
?L32:	PRINTR ". ""Let that be a warning to you, my love."""
?L31:	CALL JIGS-UP,STR?201 >STACK
	RSTACK
?L27:	EQUAL? PRSA,V?TOUCH \?L36
	FSET? LAFOND,DEADBIT /?L36
	PRINTR "He smiles."
?L36:	EQUAL? PRSA,V?GIVE \?L37
	EQUAL? PRSO,GREEN-GLASS,BLUE-GLASS \?L37
	IN? BLUE-GLASS,LAFOND /?L40
	IN? GREEN-GLASS,LAFOND \?L38
?L40:	PRINTR """I already have a glass, thank you."""
?L38:	MOVE PRSO,LAFOND
	PRINTI "He takes"
	CALL TRPRINT,PRSO
	RTRUE
?L37:	EQUAL? PRSA,V?KISS \?L42
	EQUAL? HERE,LAFS-ROOM \?L43
	GRTR? LAFOND-CTR,HORNY \?L45
	PRINTR "Queasy, you turn up your face to be kissed. His lips are cold, dry."
?L45:	PRINTR "He laughs. ""Not yet, petite."""
?L43:	PRINTI "You shudder at the thought"
	PRINT PCR
	RTRUE
?L42:	EQUAL? PRSA,V?EXAMINE \FALSE
	CALL RUNNING?,I-LSED >STACK
	ZERO? STACK /?L50
	GRTR? LAFOND-CTR,11 \?L50
	PRINTI "You turn away in modesty after a brief glimpse of pasty pink flesh"
	PRINT PCR
	RTRUE
?L50:	FSET? LAFOND,MUNGBIT \?L52
	PRINTD LAFOND
	PRINT LAF-MUNGED
	CRLF
	RTRUE
?L52:	ZERO? ENDGAME \?L54
	CALL RUNNING?,I-LSED >STACK
	ZERO? STACK /?L53
	GRTR? LAFOND-CTR,4 \?L53
?L54:	PRINTI "Lafond is dressed in a rich brocade robe"
	PRINT PCR
	RTRUE
?L53:	PRINTI "Wigged in dark brown curls, dressed in velvets and brocade, he is warmly attractive. Until you meet his eyes, stone gray and cold"
	PRINT PCR
	RTRUE
...
?L3:	CALL REPERTOIRE,STR?202 >STACK
	RSTACK
?L1:	EQUAL? PRSA,V?EXAMINE \?L4
	EQUAL? PRSO,LRING \?L5
...
?L9:	FSET? HERO,DEADBIT \?L15
	CALL NO-TIME-FOR,STR?203 >STACK
	RSTACK
?L15:	PRINTD HERO
