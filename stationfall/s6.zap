...
?L3:	PRINTR "Such language from a Lieutenant in the Stellar Patrol!"
...
?L1:	CRLF
	...
	SET 'REPEATING,1
	CALL TELL-SCORE
?L3:	PRINTI "   According to the Treaty of Gishen IV (amended after the Battle on Sorkin III in 11347 GY) you have the opportunity to restart the story, restore a saved position, or end this session of the game. In the interests of interstellar peace, type RESTART, RESTORE, or QUIT: >"
	PUTB P-LEXV,0,10
	READ P-INBUF,P-LEXV
	PUTB P-LEXV,0,60
	INC 'CNT
...
?L3:	GET P-ITBL,P-PREP1 >STACK
	...
	CALL CANT-VERB-A-PRSO,STR?73 >STACK
	RSTACK
?L4:	CALL CANT-VERB-A-PRSO,STR?74 >STACK
	RSTACK
...
?L3:	CALL IMPOSSIBLES >STACK
	...
	FSET? PRSO,VEHBIT \?L1
?L3:	CALL CANT-VERB-A-PRSO,STR?75 >STACK
	RSTACK
...
?L6:	PRINT ALREADY-IS
	RTRUE
?L4:	CALL CANT-VERB-A-PRSO,STR?75 >STACK
	RSTACK
...
?L1:	CALL IMPOSSIBLES >STACK
	...
	.FUNCT V-CRUMPLE
	CALL CANT-VERB-A-PRSO,STR?78 >STACK
	RSTACK
...
?L15:	PRINT PERIOD-CR
	...
	.FUNCT V-DRESS
	ZERO? PRSO /?L1
	CALL CANT-VERB-A-PRSO,STR?79 >STACK
	RSTACK
...
?L1:	PRINTI "It's doubtful that"
	...
	CALL DO-FIRST,STR?80,PRSO >STACK
	RSTACK
?L1:	FIRST? PRSO >X \?L3
	NEXT? X >STACK \?L4
	PRINTI "(How about"
...
?L13:	GET P-ITBL,P-PREP1 >STACK
	...
	CALL CANT-VERB-A-PRSO,STR?81 >STACK
	RSTACK
...
?L15:	GET P-ITBL,P-PREP1 >STACK
	...
	CALL CANT-VERB-A-PRSO,STR?82 >STACK
	RSTACK
...
?L18:	FSET? PRSO,NARTICLEBIT \?L19
	CALL SENSE-OBJECT,STR?83 >STACK
	RSTACK
...
?L1:	CALL HACK-HACK,STR?85 >STACK
	RSTACK
	...
	.FUNCT V-LEAP
	ZERO? STUNNED /?L1
	CALL YOURE-STUNNED,STR?86 >STACK
	RSTACK
...
?L7:	CALL IMPOSSIBLES >STACK
	...
	SET 'C-ELAPSED,18
	ZERO? PRSO /?L1
	CALL SENSE-OBJECT,STR?88 >STACK
	RSTACK
...
?L14:	FSET? PRSO,OPENBIT /?L19
	...
	RTRUE
?L19:	CALL DO-FIRST,STR?80,PRSO >STACK
	RSTACK
?L13:	GET P-ITBL,P-PREP1 >STACK
	EQUAL? STACK,PR?IN \?L24
	CALL CANT-VERB-A-PRSO,STR?89 >STACK
	RSTACK
?L24:	CALL CANT-VERB-A-PRSO,STR?90 >STACK
	RSTACK
...
?L4:	EQUAL? P-PRSA-WORD,W?PULL \?L5
	...
	RSTACK
?L5:	CALL CANT-VERB-A-PRSO,STR?93 >STACK
	RSTACK
...
?L1:	CALL UNTOUCHABLE?,PRSO >STACK
	...
	EQUAL? PRSO,ROOMS \?L1
	PRINTR "Argh! Pimples!"
?L1:	CALL HACK-HACK,STR?94 >STACK
	RSTACK
...
?L3:	EQUAL? AWAITING-REPLY,3 \?L4
	PRINTR """Figures."""
?L4:	CALL YOU-SOUND,STR?95 >STACK
	RSTACK
...
?L1:	CALL CANT-TURN,STR?96 >STACK
	RSTACK
...
?L6:	PRINTI "Okay,"
	...
	CALL NOW-LIT? >STACK
	RSTACK
?L1:	CALL CANT-TURN,STR?97 >STACK
	RSTACK
...
?L4:	FSET? PRSO,DOORBIT /?L5
	...
	CALL CANT-VERB-A-PRSO,STR?80 >STACK
	RSTACK
...
?L13:	CALL NOW-LIT?
	...
	.FUNCT V-PICK
	CALL CANT-VERB-A-PRSO,STR?98 >STACK
	RSTACK
...
?L1:	CALL HACK-HACK,STR?99 >STACK
	RSTACK
...
?L5:	FSET? PRSI,OPENBIT /?L6
	...
	CALL THIS-IS-IT,PRSI
	CALL DO-FIRST,STR?80,PRSI >STACK
	RSTACK
...
?L6:	PRINTI "You feel something inside"
	...
	CRLF
	RTRUE
?L1:	CALL CANT-VERB-A-PRSO,STR?101 >STACK
	RSTACK
...
?L1:	CALL PERFORM,V?TAKE,PRSO
	...
	.FUNCT V-ROLL
	CALL CANT-VERB-A-PRSO,STR?102 >STACK
	RSTACK
...
?L4:	FSET? PRSO,CONTBIT \?L5
	...
	PRINT PERIOD-CR
	RTRUE
?L5:	CALL CANT-VERB-A-PRSO,STR?103 >STACK
	RSTACK
...
?L1:	CALL SENSE-OBJECT,STR?106 >STACK
	RSTACK
...
?L1:	PRINTI " just like"
	...
	RTRUE
?L1:	CALL CANT-VERB-A-PRSO,STR?107 >STACK
	RSTACK
...
?L1:	PRINTR """Whoosh."""
	...
	.FUNCT PRE-TAKE
	ZERO? STUNNED /?L1
	CALL YOURE-STUNNED,STR?108 >STACK
	RSTACK
?L1:	CALL UNTOUCHABLE?,PRSO >STACK
	ZERO? STACK /?L3
	CALL CANT-REACH,PRSO >STACK
...
?L1:	CALL SENSE-OBJECT,STR?109 >STACK
	RSTACK
...
?L15:	PRINTI "You can only type numbers on this keypad."
	...
	CALL RECORDING,STR?111 >STACK
	RSTACK
?L1:	ZERO? ROBOT-PICKED /?L3
	CALL RECORDING,STR?112 >STACK
	RSTACK
?L3:	GRTR? P-NUMBER,3 \?L4
	CALL RECORDING,STR?113 >STACK
	RSTACK
?L4:	LESS? P-NUMBER,1 \?L5
	CALL RECORDING,STR?114 >STACK
	RSTACK
?L5:	EQUAL? P-NUMBER,3 \?L6
	FSET FLOYD,TOUCHBIT
...
?L7:	SET 'COURSE-PICKED,P-NUMBER
	...
	CALL RECORDING,STR?116 >STACK
	RSTACK
?L5:	CALL RECORDING,STR?117 >STACK
	RSTACK

	.FUNCT ELEVATOR-TYPE,DISTANCE
	GRTR? P-NUMBER,9 /?L3
	LESS? P-NUMBER,1 \?L1
?L3:	CALL RECORDING,STR?118 >STACK
	RSTACK
?L1:	GRTR? DAY,2 \?L4
	CALL JIGS-UP,STR?119 >STACK
	RSTACK
?L4:	EQUAL? ELEVATOR-LEVEL,P-NUMBER \?L5
	CALL RECORDING,STR?120 >STACK
	RSTACK
...
?L29:	PRINT PERIOD-CR
	...
	CALL RECORDING,STR?121 >STACK
	RSTACK
?L1:	GRTR? P-NUMBER,9 \?L3
	CALL RECORDING,STR?122 >STACK
	RSTACK
...
?L4:	LESS? P-NUMBER,1 \?L8
	CALL RECORDING,STR?114 >STACK
	RSTACK
?L8:	CALL RECORDING,STR?123 >STACK
	RSTACK
...
?L6:	EQUAL? PRSI,VALIDATION-STAMP /FALSE
	...
	RTRUE
?L1:	ZERO? STUNNED /?L3
	CALL YOURE-STUNNED,STR?124 >STACK
	RSTACK
...
?L4:	EQUAL? AWAITING-REPLY,4 \?L5
	...
	RTRUE
?L5:	CALL YOU-SOUND,STR?126 >STACK
	RSTACK
...
?L7:	IN? PRSO,PROTAGONIST /?L18
	...
	LOC PRSO >STACK
	CALL DO-FIRST,STR?80,STACK >STACK
	RSTACK
?L18:	FSET? PRSO,WORNBIT \FALSE
	CALL DO-FIRST,STR?127,PRSO >STACK
	RSTACK
...
?L1:	EQUAL? PRSA,V?SHAKE \?L3
	CALL FIND-IN,HERE,ACTORBIT,STR?128 >ACTOR
	ZERO? ACTOR /?L4
...
?L7:	EQUAL? PRSA,V?MUNG,V?KILL \?L8
	EQUAL? PRSO,ME \?L8
	CALL JIGS-UP,STR?130 >STACK
	RSTACK
?L8:	EQUAL? PRSA,V?SHOOT \?L9
	CALL JIGS-UP,STR?131 >STACK
	RSTACK
...
?L3:	EQUAL? PRSO,CLASS-THREE-SPACECRAFT-ACTIVATION-FORM \?L5
	...
	CALL RECORDING,STR?132 >STACK
	RSTACK
?L6:	REMOVE PRSO
	FSET PRSO,NDESCBIT
	PRINT FORM-ACCEPTED
	CALL RECORDING,STR?133 >STACK
	RSTACK
...
?L17:	CALL DOESNT-FIT,STR?137 >STACK
	RSTACK
...
?L1:	PRINTI "   You slowly sink into a deep sleep."
...
?L73:	ZERO? FLOYD-SHOT /?L75
	...
	CALL I-LAUNCH >STACK
	RSTACK
?L75:	CALL BACK-OFF,STR?143 >STACK
	RSTACK
...
?L127:	PRINTR """Why you do that?"" Floyd whines. ""I think a wire now shaken loose."" He goes off into a corner and sulks."
...
?L135:	PRINTR "Floyd looks at the goo. ""Yech! Got any Number Seven Heavy Grease?"""
...
?L6:	CALL JIGS-UP,STR?149 >STACK
	RSTACK
?L1:	EQUAL? SPACETRUCK-COUNTER,1 \?L8
	CALL RECORDING,STR?150 >STACK
	RSTACK
...
?L4:	CALL DOESNT-FIT,STR?157 >STACK
	RSTACK
...
?L9:	CALL DOESNT-FIT,STR?162 >STACK
	RSTACK
...
?L9:	PRINTR "The hole in the safe is already larger than the bit in the drill."
...
?L11:	PRINTR ". Eat hearty! Dispensing will now begin."" A seamless hatch in the FDU opens, and a stream of acid shoots out. You leap aside as the acid etches the floor, leaving behind some acrid fumes."
...
?L17:	EQUAL? PRSA,V?EAT \FALSE
	...
	PRINT NOT-HUNGRY
	RTRUE
?L19:	CALL JIGS-UP,STR?166 >STACK
	RSTACK
...
?L12:	EQUAL? PRSA,V?PUT \FALSE
	...
	CALL DOESNT-FIT,STR?172 >STACK
	RSTACK
?L14:	FIRST? DRILL >STACK \FALSE
	CALL DO-FIRST,STR?173 >STACK
	RSTACK
...
?L32:	PRINTR "Plato jerks out of the way and moves cautiously to the far corner of the room. ""I assure you that such antagonistic behavior is uncalled for and unappreciated."""
...
?L34:	CALL JIGS-UP,STR?176 >STACK
	RSTACK
...
?L5:	SET 'BALLOON-ODOR,1
	...
	JUMP ?L13
?L11:	CRLF
?L13:	PRINTR "   The only reminder of the late balloon is the overwhelming odor of its digestive gas."
...
?L9:	CALL DOESNT-FIT,STR?184 >STACK
	RSTACK
?L8:	EQUAL? PRSA,V?ON \FALSE
	...
	SET 'SCRAMBLED-FOOTNOTE,1
	PRINTI "(Footnote 15) "
?L5:	CALL RECORDING,STR?185 >STACK
	RSTACK
...
?L1:	PRINT NOTHING-HAPPENS
	...
	FSET? OUTER-AIRLOCK-DOOR,OPENBIT \?L3
?L5:	PRINTR "Are you nuts? The boots are the only thing preventing you from floating off into space!"
