...
<SYNTAX OPEN OBJECT (FIND CONTBIT) ON OBJECT (FIND VICBIT) = V-OPEN>
<SYNTAX OPEN OBJECT (FIND DOORBIT) ON OBJECT (FIND VICBIT) = V-OPEN>

;<SYNTAX OPEN OBJECT (FIND CONTBIT DOORBIT) IN OBJECT (FIND VICBIT) = V-OPEN>
<SYNTAX OPEN OBJECT (FIND CONTBIT) IN OBJECT (FIND VICBIT) = V-OPEN>
<SYNTAX OPEN OBJECT (FIND DOORBIT) IN OBJECT (FIND VICBIT) = V-OPEN>
